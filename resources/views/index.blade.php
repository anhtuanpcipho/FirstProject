      ...
      <tbody>
          ...
          <tr class="tr-clone tr{{$works->id}}">
              ...
              <td class="text-center text-class">
                  ...
                  <button class="btn btn-danger btn-sm edit-work-class" data-toggle="modal" data-target="#delete{{$works->id}}">Delete</button>
              </td>
          </tr>
          @include('editWork', [
          'currentId' => $works->id,
          ...
          @include('Script.script_Edit_Work', ['currentId' => $works->id])
          
          @include('Script.deleteWork', ['currentId' => $works->id])
          @endforeach
      </tbody>
    </table>
  </div>
